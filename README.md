# Weather-Dashboard
The Travel Weather Dashboard helps travelers plan their trips by providing current and future weather information for multiple cities. You can search for a city to see its current weather conditions and a 5-day forecast, including details like temperature, humidity, wind speed, and a weather icon. Your recent searches are saved, allowing you to quickly view the weather for those cities again.
